...
(function ($) {
    ...
    JFilestyle.prototype = {
        ...
        htmlInput: function () {
            if (this.options.input) {
                return '<input type="text" style="width:'+this.options.inputSize+'; float: right; background-color: #FFF; border: 1px solid #d9d9d9;" placeholder="'+ this.options.placeholder +'" disabled> ';
            } else {
                return '';
            }
        },
